...
@section('content')
    ...
    @php
    $idd = Auth::id();
    $user =App\User::with('roles')->with('permissions')->where('id',$idd)->first();
@endphp
...
<div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif  "  >
    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded" style="height:97%">
        ...
        <div class="aiz-carousel gutters-10 half-outside-arrow " data-items="3"   data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
            @foreach ($flash_deal->flash_deal_products as $key => $flash_deal_product)
                ...
                @if ($product != null && $product->published != 0)
                    <div class="carousel-box ">
                        <div class="aiz-card-box border border-primary h-385px   rounded hov-shadow-md my-2 has-transition" style="  box-shadow: 1px 2px 5px #6b6167;
" >
              ...
              @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                               ...
                               <div style="text-align: center;">
                                ...
                                <h3 class="fw-600 fs-12 text-truncate-2 lh-1-4  h-2px" style="font-size: 15px !important;">
        ...
        @else
 @php
 $baneer_flash = App\GeneralSetting::first()->baneer_flash;
