                   ...
                   @endphp
                    ...
                    @foreach (filter_products(\App\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(12)->get() as $key => $product)
                        <div class="carousel-box ">
                            <div class="aiz-card-box border border-primary  h-395px  rounded hov-shadow-md my-2 has-transition" style="  box-shadow: 3px 5px 7px #6b6167 !important;width:100% !important ">
