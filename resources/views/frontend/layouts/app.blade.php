...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/vendors.css') }}">
            <link rel="stylesheet" href="{{ static_asset('newcard/card_style.css') }}">
    @if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
    <link rel="stylesheet" href="{{ static_asset('assets/css/bootstrap-rtl.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('newcard/fontawesome/all.css') }}">
    <link rel="stylesheet" href="{{ static_asset('newcard/today.css') }}">


    <link rel="stylesheet" href="{{ static_asset('newcard/style.css') }}">
         <style>
    ...
    @else
    <link rel="stylesheet" href="{{ static_asset('newcard/style_en.css') }}">
    <link rel="stylesheet" href="{{ static_asset('newcard/today_en.css') }}">
...
AIZ.plugins.notify('danger', '{{ translate('UnFollow') }}');
    ...
    @yield('script')
    <script src="{{ static_asset('newcard/fontawesome/all.js')}}"></script>
...
@if ($ll->rtl == 0)
    ...
    $(function() {
        $('#WAButton').floatingWhatsApp({
          phone: '+96895148777', //WhatsApp Business phone number International format-
    ...
    $(function() {
        $('#WAButton').floatingWhatsApp({
          ...
          //Get it with Toky at https://toky.co/en/features/whatsapp.
          headerTitle: 'Chat with us on WhatsApp!', //Popup Title
          popupMessage: 'مرحبا كيف! يمكننا مساعدتنك؟', //Popup Message
          buttonImage: '<img src="https://rawcdn.githack.com/rafaelbotazini/floating-whatsapp/3d18b26d5c7d430a1ab0b664f8ca6b69014aed68/whatsapp.svg" />', //Button Image
          //headerColor: 'crimson', //Custom header color
          //backgroundColor: 'crimson', //Custom background button color
          position: "{{$dir}}"    
...
@endif
  ...
  return currentDay;
   ...
   function getnotifications(){
    ...
    $.get("{{ route('vistorcount')}}",{ dx: setTime(),},
  ...
  var dsklfjsd =  setInterval(function(){
    ...
    <!-- /GetButton.io widget -->
<!-- /GetButton.io widget -->
<div id="WAButton" class="icon_whats"></div>
    </body>
</html>
