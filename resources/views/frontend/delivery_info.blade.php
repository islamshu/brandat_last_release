                ...
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        <div class="card-header p-3">
                            ...
                            <h5 class="fs-16 fw-600 mb-0">{{ translate('Store Products') }} {{ get_setting('site_name') }}  </h5>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        ...
                                        <span class="fs-14 opacity-60">{{ $product->all_langname() }}</span>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
                ...
                <form class="form-default"  action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                    ...
                    @if (!empty($seller_products))
                        @foreach ($seller_products as $key => $seller_product)
                            <div class="card mb-3 shadow-sm border-0 rounded">
                                <div class="card-header p-3">
                                    <h5 class="fs-16 fw-600 mb-0"> {{ translate('Store Products') }} {{ \App\Shop::where('user_id', $key)->first()->shop_name() }}</h5>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
