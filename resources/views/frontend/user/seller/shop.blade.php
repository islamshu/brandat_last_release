                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <label class="col-md-2 col-form-label">{{ translate('Shop Name In Arabic') }}<span class="text-danger text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop In Arabic')}}" name="name_ar" disable value="{{ $shop->name_ar }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-md-2 col-form-label">{{ translate('Shop Name In English') }}<span class="text-danger text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop Name In English')}}" name="name" value="{{ $shop->name }}" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="row" style="margin-bottom:2% !important"> 
                                    ...
                                    <div class="col-md-10">
                                         <select class="form-control aiz-selectpicker" id="category" data-live-search="true" name="address">
                                                @foreach (\App\City2::where('parent_id','=','0')->get() as $key => $city)
                                                 <option value="{{ $city->id }}" @if($city->id == $shop->address) selsected @endif>{{ $city->name() }}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                </div>
                                <!--<div class="row">-->
                                <!--    <label class="col-md-2 col-form-label">{{ translate('Shop Address In English') }} <span class="text-danger text-danger">*</span></label>-->
                                <!--    <div class="col-md-10">-->
                                <!--        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop Address In English')}}" name="address" value="{{ $shop->address  }}" required>-->
                                <!--    </div>-->
                                <!--</div>-->
                                @if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'seller_wise_shipping')
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" class="form-control mb-3" placeholder="{{ translate('Shipping Cost')}}" name="shipping_cost" value="{{ $shop->getTranslation('shipping_cost',$lang) }}" required>
                                        </div>
                                    </div>
                                @endif 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Meta Title')}}" name="meta_title" value="{{  $shop->getTranslation('meta_title',$lang) }}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-md-2 col-form-label">{{ translate('Meta Description') }}<span class="text-danger text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <textarea name="meta_description" rows="3" class="form-control mb-3" required>{{  $shop->getTranslation('meta_description',$lang) }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row mb-3">
                                        <label class="col-md-2 col-form-label">{{ translate('Snapchat') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{ translate('Snapchat')}}" name="snapchat" value="{{ $shop->snapchat }}">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-md-2 col-form-label">{{ translate('Tiktok') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="{{ translate('Tiktok')}}" name="tiktok" value="{{ $shop->tiktok }}">
                                            <small class="text-muted">{{ translate('Insert link with https ') }}</small>
                                        </div>
                                    </div>
                                </div>
