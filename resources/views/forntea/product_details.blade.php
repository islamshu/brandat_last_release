                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if ($detailedProduct->brand != null)
                                    <div class="col-auto"style="border :1px solid {{ $color }}">
                            ...
                            <div class="row no-gutters align-items-center border-top">
                                ...
                                <div class="col">
                                    <ul class="social list-inline mb-0">
                                        ...
                                        <li class="list-inline-item mr-0">
                                            <a href="{{ $detailedProduct->user->shop->instagram }}" class="instagram" target="_blank">
                    ...
                    <div class="bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="p-3">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="py-3 px-0 list-group-item border-primary" style="  box-shadow: 3px 5px 7px #6b6167 !important;" >
                                    <div class="row gutters-10 align-items-center">
                                        <div class="col-5"style="border-left: 1px solid {{ $color }};border-right: 1px solid {{ $color }};">
                                        ...
                                        <div class="col-7 text-left">
                                            <h4 class="fs-13 text-truncate-2">
                                                <a href="{{ route('product', $top_product->slug) }}" class="d-block text-reset">{{ $top_product->langname() }}</a>
                                            </h4>
                            ...
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left">
                                        <?php echo $detailedProduct->langdes(); ?>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <span class="avatar avatar-md mr-3">
                                                    <img
                                                     ...
                                                     @if($review->user != null)
                                                        ...
                                                        @else
                                                            data-src="{{ uploaded_asset($error_product)  }}"
                                                        @endif
                                                        @endif
                                                    >
                                                </span>
                        ...
                        <div class="p-3">
                           ...
                           @endphp
                                ...
                                <div class="carousel-box">
                                    <div class="aiz-card-box border border-primary h-360px rounded hov-shadow-md my-2 has-transition"style="  
                                    
                                    
                                     3px 5px 7px #6b6167 !important;width:100%">
                                        <div class="">
                                            <a href="{{ route('product', $related_product->slug) }}" class="d-block">
                                                <img
                                                    class="img-fit lazyload mx-auto h-230px h-md-210px"
                                                    src="{{ uploaded_asset($error_product) }}"
                                                    data-src="{{ uploaded_asset($related_product->thumbnail_img) }}"
                                                    alt="{{ $related_product->langname() }}"
                                                    onerror="this.onerror=null;this.src='{{uploaded_asset($error_product) }}';"
                                  ...
                                  <span class="fw-700 text-primary fs-6"  style="font-size: 14px;">{{ home_discounted_base_price($related_product->id) }}</span>
                                                    @if(home_base_price($related_product->id) != home_discounted_base_price($related_product->id))
                                                    <del class="fw-600 opacity-50 " style="font-size: smaller  !important;margin: 3px;"> {{ home_base_price($related_product->id) }}</del>
                                                    @else
                                                   <del class="fw-600 opacity-50 " style="font-size: small  !important;margin: 3px; color:white">{{ home_base_price($related_product->id) }}</del>  
                                                   @endif
                                 ...
                                 <div style="text-align: center;">
                                        ...
                                        <a href="{{ route('product', $related_product->slug) }}" class="d-block text-reset" style="height: 25px;"> {{$related_product->langname()}}</a>

                                    </h3>
                                            <div class="rounded px-2 mt-2 bg-soft-primary border-soft-primary border " style="text-align: center;">
                                       <a href="javascript:void(0)" onclick="showAddToCartModal({{ $related_product->id }})" data-toggle="tooltip" data-title="{{ translate('Add to cart') }}">{{ translate('Add to cart') }}</a>
