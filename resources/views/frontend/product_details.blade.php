                                ...
                                <div class="col">
                                    <ul class="social list-inline mb-0">
                                        <li class="list-inline-item mr-0">
                                            <a href="{{ $detailedProduct->user->shop->instagram }}" class="facebook" target="_blank">
                                                <i class="lab la-instagram opacity-60"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item mr-0">
                                            <a href="{{ $detailedProduct->user->shop->snapchat}}" class="google" target="_blank">
                                                <i class="lab la-snapchat opacity-60"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item mr-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="{{ $detailedProduct->user->shop->tiktok }}" class="youtube" target="_blank">
                                               <img src="https://cdn.iconscout.com/icon/free/png-512/tiktok-3089461-2567413.png" width="20" hight="20">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
