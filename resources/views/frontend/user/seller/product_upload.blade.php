                ...
                <div class="aiz-user-panel">
                    ...
                    <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Product Name In Arabic')}}</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="name_ar" placeholder="{{ translate('Product Name In Arabic') }}" onchange="update_sku()" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                     <label class="col-md-3 col-from-label">{{translate('Description In Arabic')}}</label>
                                    <div class="col-md-8">
                                        <textarea class="aiz-text-editor" name="description_ar"></textarea>
                                    </div>
                                    
                                    
                                    <label class="col-md-3 col-from-label">{{translate('Description en')}}</label>
                                    <div class="col-md-8">
