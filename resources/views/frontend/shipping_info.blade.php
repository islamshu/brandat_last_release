                                ...
                                @foreach (Auth::user()->addresses as $key => $address)
                                    <div class="col-md-6 mb-3">
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            <input type="radio" name="address_id" value="{{ $address->id }}" @if ($key == 0)
                                                checked
                                            @endif required>
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fw-600 ml-2">{{ App\City2::find($address->postal_code)->name() }}</span>
                                                    </div>
                                                    <div>
                                                        <span class="opacity-60">{{ translate('City') }}:</span>
                                                        <span class="fw-600 ml-2">{{App\City2::find($address->city)->name()}}</span>
                                                    </div>
                                                    <div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control aiz-selectpicker" data-live-search="true" required name="country">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <select class="form-control aiz-selectpicker" id="category"  data-live-search="true" required name="city">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <select name="postal_code" id="subcategory" required  class="form-control input-sm">
                               <option  disable >{{ translate('Postal code')}} </option>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                            <select class="form-control aiz-selectpicker" required id="category" data-live-search="true" name="city">
                                                 <option value="">{{ translate('City')}}</option>
