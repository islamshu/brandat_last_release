        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('supportpolicy') }}">
                    ...
                    <i class="la la-handshake-o la-3x text-primary mb-2" aria-hidden="true"></i>
            ...
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left border-right text-center p-4 d-block"
                    ...
                    <i class="las la-bullhorn la-3x text-primary mb-2"></i>
                    ...
                    <a href="{{ route('home') }}" class="d-block">
                        @if (get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                ...
                                alt="{{ env('APP_NAME') }}" style="text-align: center" width="280" height="130">
                        @else
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}"
                                style="text-align: center" width="280" height="130">
                        @endif
                    </a>
                    <div class="my-3">
                        @php
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a class="opacity-50 hov-opacity-100 text-reset">
                                {{ translate('All Users') . ' : ' }}
                                <span>{{ App\User::where('email_verified_at', '!=', null)->count() }}</span>
                            </a>
                        ...
                        <li class="mb-2">
                            @php
                                ...
                                $count = App\Vistore::where('date', today())->count();
                                $online = 1;
                            @endphp
                            <a class="opacity-50 hov-opacity-100 text-reset ">
                                {{ translate('Number of vistore') . ' : ' }} <span
                                    class="notificount">{{ $count }}</span>
                            </a>

                        </li>
                        <li>
                            <a class="opacity-50 hov-opacity-100 text-reset">
                                {{ translate('Online User') . ' : ' }} <span
