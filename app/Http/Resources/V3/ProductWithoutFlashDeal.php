...
class ProductWithoutFlashDeal extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'photos' => uploaded_asset_nullable($this->photos),
    ...
    protected function color($item){
        return Color::whereIn('code',$item)->pluck('id','name');
    }
