...
Route::get('vistorcount','HomeController@vistorcount')->name('vistorcount');
...
Route::get('/seller_seacrh', 'HomeController@seller_seacrh')->name('seller_seacrh');

Route::post('/subscription','HomeController@subscription')->name('subscription');
Route::get('/ajax-subcat','HomeController@state');
...
//Paypal END
Route::get('/update_all', 'ProductController@update_all');
...
//SSLCOMMERZ END
Route::get('following','FollowerController@index')->name('following');
Route::get('product_following','FollowerController@product_vendor_follow');
Route::post('follow','FollowerController@store')->name('follow_seller');
//Stipe Start
...
Route::get('/all_vendors', 'HomeController@all_vendor')->name('all_vendor');
...
Route::get('/thawani', 'ThawaniController@thawani');
...
Route::group(['prefix' =>'seller', 'middleware' => ['seller', 'verified', 'user']], function(){
	...
	Route::get('/shop/edit', 'ShopController@index2')->name('shop2.edit');
...
Route::post('shops/post', 'ShopController@store')->name('store.shop');

Route::get('card', 'CardController@front')->name('cards2.get');
Route::post('cards', 'CardController@store')->name('cards2.store');
Route::delete('cards/{id}', 'HomeController@carddestroy')->name('cards2.destroy');


Route::get('vendor/pakege', 'ShopController@store2')->name('shops.store2');
...
Route::delete('user/uploaded-files/destroy_user/{id}', 'AizUploadController@destroy_user')->name('file_delete');
