            ...
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                ...
                @method('POST')
                        ...
                        <div class="bg-white rounded shadow-sm mb-3">
                            ...
                            <div class="p-3">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>{{ translate('Your Phone With whatsapp')}} <span class="text-primary">*</span></label>
                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                <label>{{ translate('Shop Name In Arabic')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ translate('Shop Name In Arabic')}}" name="name_ar" required>
                            </div>
                            <div class="form-group">
                                <label>{{ translate('Shop Name In English')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ translate('Shop Name In English')}}" name="name" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>{{ translate('Address')}} <span class="text-primary">*</span></label>
                                 <select class="form-control aiz-selectpicker" id="category" data-live-search="true" name="address">
                                                 <option disable>{{ translate('Address')}}</option>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary fw-600">{{ translate('subscribe now')}}</button>
                    </div>
                </form>
            </div>
        </div>
