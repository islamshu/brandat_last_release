                    ...
                    <div class="col">
                        <div class="aiz-carousel gutters-10" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay='true' data-infinute="true" data-dots="true">
                            @foreach ($shop->user->products->where('published', 1)->where('featured', 1) as $key => $product)
                                <div class="carousel-box">
                                    <div class="aiz-card-box border bg-white border-primary rounded  h-380px shadow-sm hov-shadow-md my-2 has-transition" style="  box-shadow: 3px 5px 7px #6b6167 !important;width:100%" >
            ...
            echo App\BusinessSetting::where('type','base_color')->first()->value;
                    @endphp;
                        ">                                            <a href="{{ route('product', $product->slug) }}" class="d-block">
                                                <img
                                                    class="img-fit lazyload    mx-auto h-220px h-sm-220px h-md-220px h-xl-220px"
                                                    src="{{ uploaded_asset($error_product)  }}"
        ...
        <div class="container">
            ...
            <div class="row gutters-5 row-cols-xxl-5 row-cols-lg-5 row-cols-md-3 row-cols-2">
                ...
                @foreach ($products as $key => $product)
                    <div class="col mb-3">
                        <div class="aiz-card-box border bg-white border-primary rounded w-200px h-380px shadow-sm hov-shadow-md my-2 has-transition" style="  box-shadow: 3px 5px 7px #6b6167 !important;width:85%">
  <div class="position-relative "style="
                            border-bottom: 1px solid @php 
            echo App\BusinessSetting::where('type','base_color')->first()->value;
                    @endphp;
